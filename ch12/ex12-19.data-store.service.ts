// 예제 12-19 DataStoreService 기본 구현
...
export class DataStoreService {
	...
	const option: FirebaseListFactoryOpts = {query: {orderByChild: queryKey,
							 equalTo: queryVal}};
    ...
    private _findObject(domain: ScmDomain, no: number, isSanpshot: boolean) {
	if ( isSanpshot ) {
